...
**Prefer stable collateral when borrowing heavily.** USDC and EURC carry far less price risk than XLM. If you are borrowing close to your limit, holding more of your collateral in stable assets reduces the chance of a sudden price move pushing you below the threshold.
