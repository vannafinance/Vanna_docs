...
Your Health Factor falls when collateral prices drop, when you borrow more, or when interest accrues on your debt — and rises when you repay debt or add collateral. One important detail: interest accrues continuously in the background, so your Health Factor can drift downward over time even if prices are flat and you take no action.

For the complete breakdown of every event that affects the ratio, see [Health Factor — Core Concepts](/learn/health-factor).
