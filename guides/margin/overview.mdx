...
You deposit collateral (XLM, USDC, or EURC) into your Margin Account and borrow assets against it. Borrowed assets stay inside your Margin Account - they cannot be sent directly to your wallet, but you can deploy them into Farm or Trade from within the account.
...
- **Assets in your wallet** - you need collateral (XLM, USDC, or EURC) ready before you can borrow.
