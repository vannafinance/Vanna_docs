...
- **Assets to deposit** — have XLM, USDC, EURC, or vTokens available in your wallet.

## What counts as collateral

You can deposit XLM, USDC, EURC, vXLM, and vUSDC as collateral. The vTokens — vXLM and vUSDC — are the yield-bearing tokens you receive when you supply assets through the Earn tab. Depositing vTokens as collateral lets you continue earning Earn yield on those assets while simultaneously using their value to back borrowed positions in your Margin Account.
