...
<Steps>
  ...
  <Step title="Select a yield pool">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/farm/LiteMode1.png" alt="Select yield pool" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
  <Step title="Deposit collateral">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/farm/LiteMode3.png" alt="Deposit collateral and set leverage" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
  <Step title="Set leverage">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/farm/LiteMode7.png" alt="Leverage slider and estimated returns" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
  <Step title="Review position metrics">
    Before deploying, review the **Position Overview** metrics:
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/farm/LiteMode5.png" alt="Position overview metrics" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
...
<div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
  <img src="/images/farm/LiteMode9.png" alt="Position tab" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
</div>
