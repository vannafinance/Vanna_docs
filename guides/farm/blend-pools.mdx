...
<Steps>
  ...
  <Step title="Select a pool">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/SingleLendingXLMPool.png" alt="Single-asset pool" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
  ...
  <Step title="View your position">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/afterAddingLiquidity.png" alt="Position after adding liquidity" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
</Steps>
...
<div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
  <img src="/images/farmSingleLendingPoolAnalyticTab.png" alt="Pool analytics" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
</div>
...
<Steps>
  ...
  <Step title="Switch to Remove Liquidity">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/removeLiquidty.png" alt="Remove liquidity panel" style={{ maxWidth: "500px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
  <Step title="Confirm">
