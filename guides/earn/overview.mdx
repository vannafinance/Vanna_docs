...
**Liquidation fees shared with LPs** - When a trader's health factor drops to the liquidation threshold, their position is liquidated. A portion of the liquidation fee is distributed to the lending pool, adding an additional revenue stream on top of borrower interest.

**Protocol flywheel** - Vanna's undercollateralized leverage model keeps pool utilization structurally higher than standard money markets, driving higher yields for LPs. [See how the Vanna Flywheel works →](/guides/how-vanna-works)
