...
<Steps>
  ...
  <Step title="Select a pool">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/earn/PoolOverview.png" alt="Pool Overview" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
  <Step title="Enter an amount">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/earn/SupplyLiquidity1.png" alt="Supply details panel" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
  ...
  <Step title="Click Supply Liquidity">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/earn/SupplyLiquidity2.png" alt="Confirm supply transaction" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
  <Step title="Confirm your position is live">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/earn/MyPositionTab.png" alt="My Position table" style={{ maxWidth: "700px", width: "100%", borderRadius: "12px" }} />
    </div>
