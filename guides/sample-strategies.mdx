...
<CardGroup cols={2}>
  ...
  <Card title="Parallel Rate Carry" href="/guides/strategies/parallel-rate-carry" icon="arrows-split-up-and-left">
    Run two simultaneous carries - XLM and EURC - from one USDC collateral base, stacking two independent rate spreads with zero price exposure on either leg.
  </Card>
  <Card title="Dual Yield Stack" href="/guides/strategies/dual-yield-stack" icon="layer-group">
    Supply EURC to Earn while running an XLM carry in Margin - two independent yield streams, zero directional exposure.
  </Card>
</CardGroup>
