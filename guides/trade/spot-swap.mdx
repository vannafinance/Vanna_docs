...
<Steps>
  ...
  <Step title="Select assets and enter an amount">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/trade/swap.png" alt="Spot Swap UI" style={{ maxWidth: "500px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
  <Step title="Choose a DEX">
    ...
    <div style={{ display: "flex", justifyContent: "center", margin: "12px 0" }}>
      <img src="/images/trade/spot-selectDex.png" alt="Select DEX" style={{ maxWidth: "500px", width: "100%", borderRadius: "12px" }} />
    </div>
  </Step>
