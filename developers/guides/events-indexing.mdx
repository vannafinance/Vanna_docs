...
data: {
  smart_account: Address,
  token_symbol:  Symbol,    // "XLM", "USDC", "EURC"
...
Applies to LendingPoolXLM, LendingPoolUSDC, and LendingPoolEURC.
...
data: {
  ...
  timestamp:    u64,
  asset_symbol: Symbol      // "XLM", "USDC", "EURC"
}
```
...
data: {
  ...
  timestamp:    u64,
  token_symbol: Symbol      // "vXLM", "vUSDC", "vEURC"
}
```
...
Standard token events on vXLM, vUSDC, vEURC contracts.
