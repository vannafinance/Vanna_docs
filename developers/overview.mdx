...
<CardGroup cols={3}>
  <Card title="Lending Integrations" icon="bank">
    Supply liquidity to XLM, USDC, or EURC pools. Read pool state (utilization, APY, exchange rate). Integrate vToken minting and redemption into your own interface.
  </Card>
...
│   LendingPools (XLM · USDC · EURC) — LP deposit/withdraw    │
└──────┬────────────────────────────────────────┬─────────────┘
       │                                        │
┌──────▼──────────────┐              ┌──────────▼──────────────┐
