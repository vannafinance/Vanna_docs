...
|---|---|---|
| **Entry** | AccountManager, LendingPoolXLM, LendingPoolUSDC, LendingPoolEURC | User-facing entry points |
...
| **Infrastructure** | Registry, Oracle, TrackingToken, vXLM, vUSDC, vEURC | Address resolution, price feeds, position tokens |
...
### LendingPools (XLM · USDC · EURC)

Three separate pool contracts, one per asset. Each pool:

- Accepts deposits and mints vTokens (vXLM, vUSDC, vEURC) proportional to share of pool
...
| `BLEND_EURC` | EURC deposited into Blend pool |
