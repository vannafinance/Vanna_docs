---
title: "Lending Pools"
description: "Function reference for LendingPoolXLM, LendingPoolUSDC, and LendingPoolEURC — deposit, vToken redemption, borrow, repay, and interest state functions."
mode: "wide"
---
...
| LendingPoolEURC | EUR Coin (EURC) | *(see [Deployed Contracts](/developers/deployed-contracts))* |
...
### deposit_xlm / deposit_usdc / deposit_eurc
...
### redeem_vxlm / redeem_vusdc / redeem_veurc
